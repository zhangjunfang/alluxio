...
public class HdfsAndAlluxioUtilsTest0 {
	// private static HdfsAndAlluxioUtils.FileSystemInfo alluxio = new
	// HdfsAndAlluxioUtils.FileSystemInfo(HdfsAndAlluxioUtils.FileSystemType.ALLUXIO,
	// "qingcheng11", 19998);
	// private static HdfsAndAlluxioUtils.FileSystemInfo hdfs = new
	// HdfsAndAlluxioUtils.FileSystemInfo(HdfsAndAlluxioUtils.FileSystemType.HDFS,
	// "qingcheng11", 9000);
	...
	// RemoteIterator<Path> paths =
	// HdfsAndAlluxioUtils.listCorruptFileBlocks(hdfs, path);
	...
	// public static void main(String[] args) {
	// String s1 = "/input/";
	// ContentSummary summary = HdfsAndAlluxioUtils.getContentSummary(alluxio,
	// s1);
	...
	// public static void main(String[] args) {
	// String s1 = "/input";
	// final List<FileStatus> statuses = HdfsAndAlluxioUtils.listStatus(alluxio,
	// s1);
	// System.out.println(statuses);
	//
	// final List<FileStatus> statuses2 = HdfsAndAlluxioUtils.listStatus(hdfs,
	// s1);
